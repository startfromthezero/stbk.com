...
$_['column_domain'] = 'Store Domain';
$_['column_url']    = 'Store URL';
$_['column_action'] = 'Action';

// Entry
$_['entry_domain']                 = 'Store Domain:<span class="help">Please fill out the need to locate the shop domain name or domain Name of the key word.</span>';
$_['entry_url']                    = 'Store URL:<span class="help">Include the full URL to your store. Make sure to add \'/\' at the end. Example: http://www.yourdomain.com/path/<br /><br />Don\'t use directories to create a new store. You should always point another domain or sub domain to your hosting.</span>';
$_['entry_ssl']                    = 'SSL URL:<span class="help">SSL URL to your store. Make sure to add \'/\' at the end. Example: http://www.yourdomain.com/path/<br /><br />Don\'t use directories to create a new store. You should always point another domain or sub domain to your hosting.</span>';
...
$_['entry_catalog_limit']          = 'Default Items Per Page (Catalog):<span class="help">Determines how many catalog items are shown per page (products, categories, etc)</span>';
...
$_['entry_icon']                   = 'Icon:<span class="help">The icon should be a PNG that is 16px x 16px.</span>';
...
$_['entry_use_ssl']                = 'Use SSL:<span class="help">To use SSL check with your host if a SSL certificate is installed.</span>';

// Error
$_['error_warning']                = 'Warning: Please check the form carefully for errors!';
$_['error_permission']             = 'Warning: You do not have permission to modify stores!';
$_['error_name']                   = 'Store Name must be between 2 and 32 characters!';
...
$_['error_telephone']              = 'Telephone must be between 2 and 32 characters!';
$_['error_domain']                 = 'Domain must be between 3 and 50 characters!';
$_['error_url']                    = 'Store URL required!';
$_['error_title']                  = 'Title must be between 2 and 32 characters!';
