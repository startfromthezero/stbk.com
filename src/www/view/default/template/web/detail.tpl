    ...
    <div class="blog-body">
        <div class="blog-container">
            <blockquote class="layui-elem-quote sitemap layui-breadcrumb shadow">
                ...
                <a href="/web/main/article" title="文章专栏">文章专栏</a>
...
pagesize(laypageId, pageSize).callback(function (newPageSize) {
    ...
    //你可以在这里使用新的页容量重新获取分页数据！
                            ...
                            <p>
                                &nbsp; &nbsp; 点赞风之迷者：<a href="http://fly.layui.com/case/2017/" target="_blank"><span style="color:#337FE5;">点击前往</span></a>&nbsp; &nbsp; 完整演示请看后台：<span><a href="http://www.lyblogs.cn/admin" target="_blank"><span style="color:#337FE5;">点击前往</span></a></span>&nbsp; &nbsp; pagesize.js下载地址：<a href="https://pan.baidu.com/s/1kVK8UhT" target="_blank"><span style="color:#337FE5;">点击前往</span></a>
                            </p>
                            <hr />
                            &nbsp; &nbsp; 出自：风之迷者
                            <p>
                ...
                <div class="blog-main-right">
                    ...
                    <div class="article-category shadow">
                        ...
                        <a href="javascript:layer.msg(<?php echo $key; ?>)"><?php echo $val; ?></a>
                        <?php } ?>
                        <div class="clear"></div>
                    </div>
