	...
	<div class="box">
		<div class="heading">
			...
			<div class="buttons" id="ctrl-div">
				<?php if ($mpermission) { ?><a href="/setting/ota/add"class="button btn-green"><?php echo $button_insert; ?></a><?php } ?>
			</div>
			<?php } ?>
			<?php if($verType == 'devices'){ ?>
			<div class="buttons" id="ctrl-div">
				<a onclick="filter();" class="button btn-blue"><?php echo $button_filter; ?></a>
				<a href="/setting/ota?verType=devices" class="button btn-red"><?php echo $button_reset; ?></a>
			</div>
			<?php } ?>
		</div>
		<div class="content">
