		...
		<tr height="100px">
			<td colspan="2">
				<div style="background:#41C0BE;height:30px;border-radius:5px;">
					<div id="plan" style="background:#FEB353;
					width:<?php echo ($card_info['used_total']/($card_info['used_total'] + $card_info['max_unused'])*100); ?>%;height:30px;
					<?php if ($card_info['max_unused'] == 0) { ?>border-radius:5px;
					<?php } else { ?> border-radius:5px 0 0 5px; <?php } ?>">
					</div>
				</div>
