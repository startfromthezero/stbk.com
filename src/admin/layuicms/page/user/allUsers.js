            	...
            	$.ajax({
					...
					success : function(data){
						...
						for(var i=0;i<usersData.length;i++){
		            		...
		            		//性别
		            		if(usersStr.set.indexOf(selectStr) > -1){
			            		usersStr["set"] = changeStr(usersStr.set);
		            		}
		            		//会员等级
		            		if(usersStr.user_group_id.indexOf(selectStr) > -1){
			            		usersStr["user_group_id"] = changeStr(usersStr.user_group_id);
		            		}
		            		if(usersStr.username.indexOf(selectStr)>-1 || usersStr.email.indexOf(selectStr)>-1 || usersStr.set.indexOf(selectStr)>-1 || usersStr.user_group_id.indexOf(selectStr)>-1){
