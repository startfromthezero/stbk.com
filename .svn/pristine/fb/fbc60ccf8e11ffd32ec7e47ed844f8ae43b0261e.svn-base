...
$('select[name=\'config_country_id\']').on('change', function(){loadCounty(this.value, '<?php echo $config_zone_id; ?>', 'config_country_id', 'config_zone_id', 'city', 'postcode-required')});
