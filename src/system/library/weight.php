...
class Weight extends modules_mem
{
	...
	public function __construct($registry)
	{
		...
		$weight_class_rows = $this->sdb()->fetch_all('SELECT * FROM ' . DB_PREFIX . "weight_class wc LEFT JOIN " . DB_PREFIX . "weight_class_description wcd ON (wc.weight_class_id = wcd.weight_class_id) WHERE wcd.language_id = '{$this->language_id}'");
		foreach ($weight_class_rows as $result)
		{
