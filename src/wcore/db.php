 ...
 * 版本: $Id: db.php 371 2016-07-06 10:06:35Z zhangsl $
 *
...
class wcore_db
{
	 ...
	 * @return integer 插入成功成返回自动编号，失败返回0
	 */
	public function insert($opt, &$data, $show_err = true)
	{
		...
		return $this->affected_rows() ? $this->insert_id() : 0;
	}
	...
	public function halt($msg, $line = 0, $db_err = '')
	{
		...
		{
			file_put_contents(DIR_ROOT . '/system/logs/db.log', date('Y-m-d H:i:s') . " - Error: {$db_err}\nContent: {$msg}\n\n", FILE_APPEND);
		}
