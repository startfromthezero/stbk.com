                ...
                <div class="layui-tab layui-tab-brief shadow" lay-filter="tabAbout">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item">
                            <div class="aboutinfo">
                                <div class="aboutinfo-figure">
                                    <img src="/public/images/Logo_100.png" alt="风之迷者" />
                                </div>
                                <p class="aboutinfo-nickname">风之迷者</p>
                                ...
                                <div class="aboutinfo-contact">
                                    ...
                                    <a target="_blank" title="文章专栏" href="/web/main/article"><i class="fa fa-file-text fa-2x"></i></a>
                                    <a target="_blank" title="资源分享" href="/web/main/resource"><i class="fa fa-tags fa-2x"></i></a>
                                    <a target="_blank" title="点点滴滴" href="/web/main/timeline"><i class="fa fa-hourglass-half fa-2x"></i></a>
                                </div>

                                <fieldset class="layui-elem-field layui-field-title">
                                    <legend>简介</legend>
                                    <div class="layui-field-box aboutinfo-abstract">
                                        <p style="text-align:center;">风之迷者是一个由ASP.NET MVC开发的个人博客网站，诞生于2016年11月7日，起劲为止经历了一次大改，暂且称为风之迷者2.0。</p>
                                        <h1>第一个版本</h1>
                            ...
                            <div class="aboutinfo">
                                ...
                                <fieldset class="layui-elem-field layui-field-title">
                                    ...
                                    <div class="layui-field-box aboutinfo-abstract abstract-bloger">
                                        <p style="text-align:center;">Absolutely，风之迷者创始人，诞生于1996年2月14日，目前是一个码农，从事.NET开发。</p>
                                        <h1>个人信息</h1>
                                        <p>暂无</p>
                                        <h1>个人介绍</h1>
                        ...
                        <div class="layui-tab-item">
                            <div class="aboutinfo">
                                <div class="aboutinfo-figure">
                                    <img src="/public/images/handshake.png" alt="友情链接" />
                                </div>
                                <p class="aboutinfo-nickname">友情链接</p>
                                <p class="aboutinfo-introduce">Name：风之迷者&nbsp;&nbsp;&nbsp;&nbsp;Site：www.lyblogs.cn</p>
                        ...
                        <div class="layui-tab-item">
                            <div class="aboutinfo">
                                <div class="aboutinfo-figure">
                                    <img src="/public/images/messagewall.png" alt="留言墙" />
                                </div>
                                            ...
                                            <ul class="blog-comment">
                                                <li>
                                                    <div class="comment-parent">
                                                        <img src="/public/images/Logo_40.png" alt="风之迷者" />
                                                        <div class="info">
                                                            <span class="username">风之迷者</span>
                                                        </div>
                                                        <div class="content">
                                                            我为大家做了模拟留言与回复！试试吧！
                                                        </div>
